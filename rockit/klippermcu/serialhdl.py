...
#
# rockit.klippermcu modifications Copyright (C) 2025 Paul Chote <p.chote@warwick.ac.uk>
...
class SerialReader:
    def __init__(self, reactor, warn_prefix=""):
        ...
        self.ffi_lib = NativeLib()
        self.default_cmd_queue = self.alloc_command_queue()
        self.stats_buf = create_string_buffer(4096)
        # Threading
    ...
    def _bg_thread(self):
        ...
        while 1:
            self.ffi_lib.serialqueue_pull(self.serialqueue, pointer(response))
            count = response.len
            if count < 0:
                break
    ...
    def _start_session(self, serial_dev, serial_fd_type=b'u', client_id=0):
        ...
        self.serialqueue = self.ffi_lib.serialqueue_alloc(serial_dev.fileno(), serial_fd_type, client_id)
    ...
    def connect_file(self, debugoutput, dictionary, pace=False):
        ...
        self.serialqueue = self.ffi_lib.serialqueue_alloc(self.serial_dev.fileno(), b'f', 0)
    ...
    def stats(self, eventtime):
        ...
        return self.stats_buf.value.decode('ascii')
